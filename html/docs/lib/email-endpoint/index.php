...
//    $mail->SMTPDebug = SMTP::DEBUG_SERVER;                      //Enable verbose debug output
    ...
    $mail->Body = "<style>@font-face {font-family: 'Gotham';font-weight: 400;src: url('https://www.quizza.org/static/fonts/gotham-reg.ttf') format(truetype');}@font-face {font-family: 'Gotham';font-weight: 700;src: url('https://www.quizza.org/static/fonts/gotham-bold.ttf') format('truetype');}*{font-family:'Gotham';}</style><div style='padding:12px;text-align:center;'><h1 style='text-align:center;'>$from_name Sent a Study Set</h1><p style='text-align:center;'><img src='https://www.quizza.org/static/images/favicon.png' style='height:20px;'><br>$from_name ($from_email) has invited you to collaborate on a private study set ($setname) on Quizza. Access your Quizza sets at <a href='https://www.quizza.org/private'>quizza.org/private</a>.</p><p><a href='https://www.quizza.org/private'><button style='color:#rgba(0,0,0,0);border:2px solid #0668FD;border-radius:8px;padding:8px;'>Open Quizza</button></a></p><p><small>Copyright 2022 &copy; Ryland Goldman and Collin Wentzien</small></p></div>";
    $mail->send();
} catch (Exception $e){

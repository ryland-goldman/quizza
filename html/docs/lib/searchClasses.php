...
$result1 = $admin->query("SELECT * FROM Classes WHERE LOWER(LongName) REGEXP \"^".$query."\" OR LOWER(LongName)=\"".$query."\" ORDER BY LongName ASC LIMIT 10;");
$result1 = $admin->query("SELECT * FROM Classes WHERE LOWER(ShortName) REGEXP \"".$query."\" ORDER BY ShortName ASC LIMIT 10;");
$result1 = $admin->query("SELECT * FROM Classes WHERE LOWER(LongName) REGEXP \"".$query."\" ORDER BY LongName ASC LIMIT 10;");

...
<head>
	...
	<?php if(isset($mathjax)) { ?><script id="MathJax-script" async src="https://cdn.jsdelivr.net/npm/mathjax@3.0.1/es5/tex-mml-chtml.js"></script><script type="text/x-mathjax-config" defer>MathJax.Hub.Queue(function () {window.print()});</script><?php } else {?><script defer>window.print();</script><?php } ?>
</head>
<body>
	<div id='name'>
		<div>Name:</div>

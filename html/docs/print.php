...
<head>
	...
	<?php if(isset($mathjax)) { ?><script>MathJax = {startup: {pageReady: () => {return MathJax.startup.defaultPageReady().then(() => {window.print();});}}};</script><script defer id="MathJax-script" src="https://cdn.jsdelivr.net/npm/mathjax@3.0.1/es5/tex-mml-chtml.js"></script><?php } else {?><script defer>window.print();</script><?php } ?>
</head>
<body>
	<div id='name'>
		<div>Name:</div>
